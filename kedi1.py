...
video_path = "kedi1.mp4"

# Minimum ve maksimum kedi boyutları (genişlik ve yükseklik)
min_kedi_boyutu = (100, 100)
max_kedi_boyutu = (300, 300)
...
while True:
    ...
    # Kedileri tespit et
    rects = detector.detectMultiScale(gray, scaleFactor=1.045, minNeighbors=2, minSize=min_kedi_boyutu, maxSize=max_kedi_boyutu)
